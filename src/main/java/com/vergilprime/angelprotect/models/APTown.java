...
public class APTown {
    ...
    public HashMap<String, Object> serialize() {
        ...
        serializedTown.put("townID", townID);
        serializedTown.put("townDisplay", townDisplay);
        serializedTown.put("mayor", mayor);
        serializedTown.put("assistants", assistants);
        serializedTown.put("members", members);
